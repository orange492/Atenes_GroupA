...
public class Player : MonoBehaviour
{
    ...
    {
        inputActions.Shooting.Fire.performed -= OnFireStart;
        inputActions.Shooting.Fire.canceled -= OnFireStop;
    ...
    private void OnMove(InputAction.CallbackContext context)
    {
        ...
        //dir.y < 0   // S를 눌렀다.
        anim.SetInteger("Input", (int)dir.x); // 애니메이션 적용 좌우 이동시
    }
    ...
    private void Awake()
    {
        inputActions = new InputActions();     // 액션맵 인스턴스 생성
    ...
    {
        inputActions.Shooting.Enable();   // 오브젝트가 생성되면 입력을 받도록 활성화
